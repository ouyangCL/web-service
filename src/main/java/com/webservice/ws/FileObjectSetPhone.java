...
@XmlType(name = "FileObjectSetPhone", namespace = "http://ws.webservices.com", propOrder = {
    "file",
    "info",
    "license",
    "type"
...
public class FileObjectSetPhone {
    ...
    @XmlElementRef(name = "info", namespace = "http://ws.webservices.com", type = JAXBElement.class, required = false)
