 ...
 * 
 */
@WebServiceClient(name = "TestService", targetNamespace = "http://service.webservice.com", wsdlLocation = "http://localhost:8080/service/webservice?wsdl")
    ...
    extends Service
{
    ...
    private final static QName TESTSERVICE_QNAME = new QName("http://service.webservice.com", "TestService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/service/webservice?wsdl");
    ...
    public TestService getTestServiceImplPort() {
        return super.getPort(new QName("http://service.webservice.com", "TestServiceImplPort"), TestService.class);
    }
    ...
    public TestService getTestServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.webservice.com", "TestServiceImplPort"), TestService.class, features);
    }
